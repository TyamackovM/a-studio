  ...
  return (
    <>
      <motion.div
       ...
       bg-[#3b3c45]" variants={transitionVariants} initial='initial' animate='animate'
      ...
      <motion.div 
       ...
       bg-[#343436]" variants={transitionVariants} initial='initial' animate='animate'
      ...
      <motion.div
       ...
       bg-[#545353]" variants={transitionVariants} initial='initial' animate='animate'
